...
public final class AConsideringIterationCmd extends PIterationCmd
{
    private PExp _i_;
    private PExp _ini_;
    private PExp _fim_;
    private PExp _inc_;
    private PCmd _cmdCons_;

    public AConsideringIterationCmd()
    {
        // Constructor
    }
    ...
    public AConsideringIterationCmd(
        ...
        @SuppressWarnings("hiding") PCmd _cmdCons_)
    {
        // Constructor
        setI(_i_);
    ...
    public Object clone()
    {
        return new AConsideringIterationCmd(
            cloneNode(this._i_),
    ...
    {
        ((Analysis) sw).caseAConsideringIterationCmd(this);
    }
    ...
    public PCmd getCmdCons()
    {
        return this._cmdCons_;
    }

    public void setCmdCons(PCmd node)
    {
