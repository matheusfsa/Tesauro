...
public final class ABlocoCmdNoShortIct extends PCmdNoShortIct
{
    private PBloco _bloco_;

    public ABlocoCmdNoShortIct()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoCmdNoShortIct(
    ...
    {
        ((Analysis) sw).caseABlocoCmdNoShortIct(this);
    }
